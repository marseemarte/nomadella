...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $conn->query("UPDATE ordenes SET estado='$estado' WHERE id_orden=$id_orden");

    // Actualizar servicios adicionales y alquiler de auto
    ...
    // Insertar alquiler de auto seleccionado (solo uno)
